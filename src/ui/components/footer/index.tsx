...
export const Footer: React.FC = () => {
  return (
    <div className="text-center py-5 bg-gray-800">
      <a href="https://github.com/pankod" target="_blank" className="block mb-3" rel="noreferrer">
        <PankodIcon data-test="icon" className="text-white mx-auto" width="140" height="28" />
      </a>
